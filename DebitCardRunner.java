class DebitCardRunner{
    ...
    public static void main(String debit[]){
		...
		card4.cardId = 634271;
		card4.cardHolderName = "Keerthi Kumar";
		...
		card7.cardId = 68980;
		card7.cardHolderName = "SriRaksha";
		...
		card8.cardId = 47658;
		card8.cardHolderName = "Vaishnavi";
